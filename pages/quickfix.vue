			...
			<div class="bg-white rounded-lg p-4 text-center shadow-lg mb-2" id="Customer Information Block">
				...
				<div class="flex-wrap overflow-hidden">
					<input :key=index v-for="(key, index) in customerInformation"
						   class="formTextInput focus:outline-none border-transparent focus:border-orange-500 border-2 mx-2 my-2 text-center w-full lg:w-1/3"
				...
				<div id="Computer Information Block" class="text-center p-4 m-2">
					...
					<div class="align-middle flex-wrap overflow-hidden">
						<select class="focus:outline-none border-2 border-transparent focus:border-orange-500 formTextInput mx-2 my-2 text-center w-full md:w-auto"
								id="MFG Selection">
						...
						<input type="text"
							   class="focus:outline-none border-2 border-transparent focus:border-orange-500 formTextInput mx-2 my-2 text-center w-full md:w-1/3"
				...
				<div id="Fix Description" class="text-center ">
					<textarea cols="50" rows=10 v-model="fix" class="myTextArea focus:border-orange-500" placeholder="Describe Fix"></textarea>
				</div>
