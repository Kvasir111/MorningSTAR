<template>
	<div class="bg-white w-full rounded shadow-md p-2 mt-2 hover:shadow-lg card">
		...
		<div class="inline-block align-bottom justify-end">
			<button v-on:click="showDetails" v-bind:id="SOdetailButton" class="bg-orange-600 px-2 inline fontMont text-white rounded-lg ">
				{{text}}
